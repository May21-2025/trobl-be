...
public enum NotificationType {
    ...
    PARTNER_REQUEST(NotificationStrategy.IMMEDIATE, "notification.partner_request"),
    PARTNER_DECLINED(NotificationStrategy.IMMEDIATE, "notification.partner_declined"),
    PARTNER_ACCEPTED(NotificationStrategy.IMMEDIATE, "notification.partner_accepted"),
